...
export const PRIMARY_COUPON = "BADMUN001";
...
export const PAGE_DATA: Record<string, CouponData> = {
  home: {
    ...
    metaDesc: "Get verified PW Coupon Code 2026. Use BADMUN001 for maximum discount on all Physics Wallah batches.",
  ...
  pwCoupon: {
    ...
    metaDesc: "Save big on any PW course with the official PW Coupon Code 2026. Apply code BADMUN001 now.",
    h1: "PW Coupon Code 2026",
  ...
  jee: {
    ...
    metaDesc: "Preparing for IIT JEE 2026? Use PW JEE Coupon Code 2026: BADMUN001 to get the best price on Lakshya & Arjun batches.",
  ...
  neet: {
    ...
    metaDesc: "Unlock massive discounts on PW NEET batches with PW NEET Coupon Code 2026. Use code BADMUN001 today.",
  ...
  gate: {
    ...
    metaDesc: "Get the latest PW GATE Coupon Code 2026. Use BADMUN001 for heavy discounts on GATE Wallah courses.",
